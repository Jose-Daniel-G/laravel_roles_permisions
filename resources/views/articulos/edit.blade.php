            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form action="{{ route('articulos.update', $articulo->id)}}" method="POST">
                        ...
                        <div class="my-3">
                            <input value="{{old('titulo',$articulo->titulo)}}" type="text" placeholder="titulo" name="titulo" id="titulo" class="border-gray-300 shadow-sm w-1/2 rounded-lg">
                            @error('titulo')
                        ...
                        <div class="my-3">
                            <input value="{{old('autor',$articulo->autor)}}" type="text" placeholder="autor" name="autor" id="autor" class="border-gray-300 shadow-sm w-1/2 rounded-lg">
                            @error('autor')
                                <p class="text-red-400 font-medium">{{$message}}</p>
                            @enderror
                        </div>

                        ...
                        <tbody>
                            @if ($articulos->isNotEmpty())
                                ...
                                <tr>
                                    ...
                                    <td  class="px-6 py-3 text-left">
                                        <a href="{{ route('permissions.edit', $articulo->id)}}" class="bg-slate-700 text-sm rounded-md px-5 py-3 py-2 hover:bg-slate-600">Editar</a>
                                        ...
                                        <form action="{{ route('permissions.destroy', $articulo->id) }}" method="POST" class="inline">
                                            @csrf
                                            @method('DELETE')
